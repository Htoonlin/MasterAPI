 ...
 */
package com.sdm.core.mysql.model;
...
public class PropertyModel implements Serializable {
    ...
    public String defaultSQL() {
        ...
        if (this.type instanceof com.sdm.core.mysql.model.type.Integer) {
            com.sdm.core.mysql.model.type.Integer integerType = (com.sdm.core.mysql.model.type.Integer) this.type;
            if (integerType.isSerial()) {
                this.primary = true;
                this.serial = true;
            }
        } else if (this.type instanceof com.sdm.core.mysql.model.type.Text) {
            com.sdm.core.mysql.model.type.Text textType = (com.sdm.core.mysql.model.type.Text) this.type;
