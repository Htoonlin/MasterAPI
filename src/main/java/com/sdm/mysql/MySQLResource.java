...
import com.sdm.mysql.request.structure.AddPropertyRequest;
import com.sdm.mysql.request.structure.CloneRequest;
import com.sdm.mysql.request.structure.RenameRequest;
import com.sdm.mysql.request.structure.CreateRequest;
import com.sdm.mysql.request.data.DataRemoveRequest;
import com.sdm.mysql.request.structure.EditPropertyRequest;
import com.sdm.mysql.request.structure.RemovePropertyRequest;
import com.sdm.mysql.request.structure.RemoveRequest;
...
public class MySQLResource extends DefaultResource {
    ...
    public IBaseResponse update(@PathParam("table") String table,
            DataUpdateRequest request) throws SQLException, IOException, ClassNotFoundException {
        if (!request.isValid()) {
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    public IBaseResponse update(@PathParam("table") String table,
            DataRemoveRequest request) throws SQLException, IOException, ClassNotFoundException {
        if (!request.isValid()) {
            return new ErrorResponse(request.getErrors());
        }
        RestDAO dao = new RestDAO();
