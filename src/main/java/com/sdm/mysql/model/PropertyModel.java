 ...
 * @author Htoonlin
 */
public class PropertyModel extends SQLModel implements Serializable {
    ...
    public String defaultSQL() {
        String sql = quoteName(this.name) + " " + this.type.getSQL();
        ...
        if (!this.description.isEmpty()) {
            sql += " COMMENT '" + escapeQuery(this.description) + "'";
        }
