...
public class PermissionResource extends RestResource<PermissionEntity, Long>{
    ...
    protected void onLoad() {
        mainDAO = new PermissionDAO(getHttpSession());
    }
    ...
    public DefaultResponse multiPermissions(List<PermissionEntity> permissionList) throws Exception {        
        try {
    ...
    @GET
    @Path("/role/{roleId:\\d+}")
    public DefaultResponse getPermissionsByRole(@PathParam("roleId") int roleId) throws Exception{
        try{
