    ...
    <body>
        <div
            ...
            <div
                ...
                <h1
                    style="margin: 20px 50px 10px; font-size: 21px; border-bottom: 3px solid #c97800; padding-bottom: 20px; font-weight: 500;">ACTIVATE
                    YOUR ACCOUNT</h1>
            ...
            <div
                ...
                <p>
                    This activation button will be expired in next <b>${expire}</b>
                    minutes.
                </p>
