    ...
    <body>                
        <div style="box-shadow: 3px 3px 5px #666;border: 1px solid #dabb74;border-radius: 3px;margin: 28px;font-family: arial;">
            <div style="color: #c35a00;background-color: #fbf2db;border-bottom: 1px solid #c5a456;padding: 20px 50px;text-align: center;">
                <h1 style="margin: 20px 50px 10px;font-size: 21px;border-bottom: 3px solid #c97800;padding-bottom: 20px;font-weight: 500;">Forget Password Request</h1>  
            ...
            <div style="margin:20px 50px;padding: 28px 50px;background: #FFF;font-size: 11pt;">     
                ...
                <p>This reset button will be expired in next <b>${expire}</b> minutes.</p>
