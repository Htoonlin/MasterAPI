...
<link rel="stylesheet"
	href='http://mmwebfonts.comquas.com/fonts/?font=myanmar3'
	type="text/css" />
<style type="text/css">
	...
	<div class="container">
		...
		<div class="input-group">
			<span class="input-group-addon">ACCESS TOKEN :</span> <input
				...
				id="txtAccessToken" value="Bearer <%=accessToken%>" />
		</div>
		<hr />
		...
		<div class="panel panel-info" id="mainPanel">
			<div class="panel-heading">
				<div class="form-group row">
					<div class="col-md-10">
						<div class="input-group">
							<span class="input-group-addon">API URL :</span> <input
								type="url" class="form-control" id="txtAPIURL" />
						</div>
					</div>
					<div class="col-md-2">
						<button class="btn btn-primary btn-block" id="btnNew"
							disabled="disabled" type="button" onclick="show_modal(0)">
				...
				<div class="row">
					<div class="col-md-3">
						<div class="input-group">
							...
							</span> <input type="text" class="form-control" id="txtFilter" />
						</div>
					</div>
					<div class="col-md-2">
						<div class="input-group">
							<span class="input-group-addon">Page</span> <input type="number"
								class="form-control" id="txtPage" value="0" />
						</div>
					</div>
					<div class="col-md-2">
						<div class="input-group">
							<span class="input-group-addon">Size</span> <input type="number"
								class="form-control" id="txtSize" value="10" />
						</div>
					</div>
					<div class="col-md-3">
						<div class="input-group">
							<span class="input-group-addon">Sort</span> <input type="text"
								class="form-control" id="txtSort" />
						</div>
					</div>
					<div class="col-md-2">
				...
				call_api('struct', 'get', null, function(response) {
					...
					$.each(content, function(index, property) {
						if (property.request_name && $.inArray(property.request_name, hide_columns) === -1) {
							blank_object[property.request_name] = '';
