                ...
                <form class="form" role="form" id="frmResetPassword">
                    <div id="auth-box" class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <label class="control-label">Confirm-Password :</label> <span
                                    class="label label-danger" id="msgConfirmPassword"></span>
                                <div class="input-group">
                                    <span class="input-group-addon"> <span
                                            class="glyphicon glyphicon-lock"></span>
                                    </span> <input type="password" id="txtCPassword" class="form-control"
